...
const AboutSection = memo(() => {
  ...
  return (
    <section id="gioithieu" className="bg-[#e7ece5] py-20">
      <div className="container mx-auto px-4">
        ...
        >
          <motion.h2 
            className="text-black font-extrabold text-[2rem] lg:text-[3rem] mb-3 leading-tight"
            variants={fadeInUp}
          >
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <motion.div 
              ...
              variants={fadeInUp}
            >
              <p className="text-black w-full leading-tight mb-8 text-justify">
                {t('home.about_section.main_description')}
              </p>
              <div className="h-[20rem] lg:h-[40rem] xl:h-[50rem]">
                <LazyImage
            ...
            >
              <div>
                <div className="h-[20rem] lg:h-[20rem] xl:h-[30rem] mb-8">
                  <LazyImage
                ...
                <p className="text-black leading-tight mb-12 text-justify">
                  {t('home.about_section.secondary_description')}
                </p>
              </div>
              <motion.div 
                className="grid grid-cols-1 sm:grid-cols-3 gap-10 text-black"
                variants={staggerChildren}
              >
                <motion.div variants={fadeInUp}>
                  <h3 className="font-extrabold mb-1 leading-tight text-[14px]">
        ...
        >
          <motion.div className="w-1/2 md:w-1/4 mb-12 md:mb-0" variants={fadeInUp}>
            <p className="text-[40px] sm:text-[50px] font-semibold leading-none text-black">
