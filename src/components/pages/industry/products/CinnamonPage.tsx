...
const CinnamonPage = memo(() => {
  ...
  const cinnamonImages = [
    {
      src: '/images/pages/industry/Cinnamon/cinnamon1.webp',
      alt: 'Vỏ quế nguyên cây chất lượng cao của Tấn Tài',
      width: 800,
      height: 600
    },
    {
      src: '/images/pages/industry/Cinnamon/cinnamon2.webp',
      alt: 'Quy trình chế biến và đóng gói quế tại nhà máy',
      width: 800,
      height: 600
    },
    {
      src: '/images/pages/industry/Cinnamon/cinnamon3.webp',
  ...
  return (
    <IndustryProductLayout 
      ...
      heroImageUrl="/images/pages/industry/Cinnamon/cinnamon1.webp"
    >
      <ProductDetail 
