...
const TapiocaPage = memo(() => {
  ...
  const tapiocaImages = [
    {
      src: '/images/pages/industry/TapiocaStarch/topiocastartch1.webp',
      alt: 'Tinh bột sắn chất lượng cao Tấn Tài',
      width: 800,
      height: 600
    },
    {
      src: '/images/pages/industry/TapiocaStarch/topiocastartch2.webp',
      alt: 'Quy trình sản xuất tinh bột sắn tại nhà máy Tấn Tài',
      width: 800,
      height: 600
    },
    {
      src: '/images/pages/industry/TapiocaStarch/topiocastartch3.webp',
  ...
  return (
    <IndustryProductLayout 
      ...
      heroImageUrl="/images/pages/industry/TapiocaStarch/topiocastartch1.webp"
    >
      <ProductDetail 
