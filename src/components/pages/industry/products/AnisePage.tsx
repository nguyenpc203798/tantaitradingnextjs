...
const AnisePage = memo(() => {
  ...
  const aniseImages = [
    {
      src: '/images/pages/industry/StarAnise/staranise1.webp',
      alt: 'Hoa hồi khô nguyên sao chất lượng cao',
      width: 800,
      height: 600
    },
    {
      src: '/images/pages/industry/StarAnise/staranise2.webp',
      alt: 'Quy trình phân loại và đóng gói hoa hồi tại nhà máy Tấn Tài',
      width: 800,
      height: 600
    },
    {
      src: '/images/pages/industry/StarAnise/tablestaranise.webp',
  ...
  return (
    <IndustryProductLayout 
      ...
      heroImageUrl="/images/pages/industry/StarAnise/staranise1.webp"
    >
      <ProductDetail 
