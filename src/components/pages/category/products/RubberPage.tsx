  ...
  const rubberContent = (
    <>
      ...
      <div className="space-y-6">
        <p>{t("category.products.rubber.description.paragraph1")}</p>
        <p>{t("category.products.rubber.description.paragraph2")}</p>
        <p>{t("category.products.rubber.description.paragraph3")}</p>
      </div>
    </>
  );
